...
class FileSystem {
  public:
    ...
    bool Create(char *name, int initialSize, int type = 0, char *path = "");  	
    ...
    bool externFileLength(char *name, int size);

    char openFileNames[MAX_FILE_NUM][50];
    int refCnt[MAX_FILE_NUM];
  private:
